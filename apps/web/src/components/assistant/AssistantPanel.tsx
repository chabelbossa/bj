  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
      <form onSubmit={submitQuestion} className="rounded-md border border-line bg-surface p-5">
        ...
        {status === "error" ? (
          <p className="mt-3 text-sm text-danger">Impossible d&apos;obtenir une réponse sourcée.</p>
        ) : null}
      ...
      <section className="rounded-md border border-line bg-surface p-5" aria-live="polite">
        ...
        {answer ? (
          ...
          <p className="mt-4 text-sm leading-6 text-muted">
            Posez une question. Le provider configuré répond uniquement à partir des sources
            connectées.
          </p>
        )}
      </section>
